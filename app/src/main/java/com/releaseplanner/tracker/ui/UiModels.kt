...
data class ReleaseTrackerUiState(
    ...
    val readStreakStartDate: LocalDate? = null,
    val completeStreakStartDate: LocalDate? = null,
    val longestReadStreakStartDate: LocalDate? = null,
    val longestCompleteStreakStartDate: LocalDate? = null,
    val debugReadStreakStartDate: LocalDate? = null,
    val debugCompleteStreakStartDate: LocalDate? = null,
